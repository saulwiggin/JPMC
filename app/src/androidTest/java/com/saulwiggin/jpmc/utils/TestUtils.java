...
public class TestUtils {
    ...
    public static com.saulwiggin.jpmc.utils.RecyclerViewMatcher withRecyclerView(final int recyclerViewId) {

        return new com.saulwiggin.jpmc.utils.RecyclerViewMatcher(recyclerViewId);
    }
